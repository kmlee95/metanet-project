		...
		<nav class="nvb">
			...
			<div class="nvb-m" id="menu">
				<c:if test="${member != null}">
					...
					<c:if test="${Menu.AG0003 eq 'Y'}">
						<div class="nav-item">
							<a class="nav-link" id="nvbVacationManage" href="/login/vmanager/vmanagerAnnual">연차
								관리</a>
						</div>
