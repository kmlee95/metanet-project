		...
		<div class="card">
			<div class="section-container">
				<section class="about-area" id="about">
					...
					<hr>
					<div class="picture">
						<c:if test="${member.emp_code eq 'E0001'}">
							<img src="/resources/img/program.jpg">
						</c:if>
						<c:if test="${member.emp_code eq 'E0002'}">
							<img src="/resources/img/people1.jpg">
						</c:if>
						<c:if test="${member.emp_code eq 'E0003'}">
							<img src="/resources/img/people2.jpg">
						</c:if>
						<c:if test="${member.emp_code eq 'E0005'}">
							<img src="/resources/img/people3.jpg">
						</c:if>
						<c:if test="${member.emp_code eq 'E0006'}">
							<img src="/resources/img/people5.jpg">
						</c:if>
				
						<c:if test="${member.emp_code eq 'E0008'}">
							<img src="/resources/img/people7.png">
						</c:if>
						<c:if test="${member.emp_code eq 'E0009'}">
							<img src="/resources/img/people6.JPG">
						</c:if>
						<c:if test="${member.emp_code eq 'E0010'}">
							<img src="/resources/img/people7.png">
						</c:if>
						<c:if test="${member.emp_code eq 'E0011'}">
							<img src="/resources/img/people7.png">
						</c:if>
						<c:if test="${member.emp_code eq 'E0012'}">
							<img src="/resources/img/people8.jpg">
						</c:if>
						<c:if test="${member.emp_code eq 'E0013'}">
							<img src="/resources/img/people7.png">
						</c:if>
						<c:if test="${member.emp_code eq 'E0017'}">
							<img src="/resources/img/people4.jpg">
						</c:if>
					...
					<div class="text">
						<div class="notice notice-info">
							<ul>
								...
								<li>
									<div class="info">
										<i class="fas fa-sitemap"></i> 조직 구분 : ${member.code_name}
									</div>
								</li>
								<li>
									<div class="info">
