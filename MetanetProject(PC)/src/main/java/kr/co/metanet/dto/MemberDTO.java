...
public class MemberDTO {
	...
	private String code_name;//코드이름
	
	private float acq_days_num;//휴가 발생일 수
	private float use_days_num;//휴가 사용일 수
	private float res_days_num;//휴가 잔여일 수
	...
	public float getAcq_days_num() {
		return acq_days_num;
	}
	public void setAcq_days_num(float acq_days_num) {
		this.acq_days_num = acq_days_num;
	}
	public float getUse_days_num() {
		return use_days_num;
	}
	public void setUse_days_num(float use_days_num) {
		this.use_days_num = use_days_num;
	}
	public float getRes_days_num() {
		return res_days_num;
	}
	public void setRes_days_num(float res_days_num) {
